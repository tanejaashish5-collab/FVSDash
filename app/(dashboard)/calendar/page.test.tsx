...
import { ToastProvider, useToasts } from '@/lib/ToastProvider';
...
jest.mock('@/lib/ToastProvider', () => ({
    ...(jest.requireActual('@/lib/ToastProvider') as object),
    useToasts: jest.fn(),
}));
const mockedUseToasts = useToasts as jest.Mock;
...
describe('CalendarPage Drag and Drop', () => {
  ...
  beforeEach(() => {
    mockedUseToasts.mockReturnValue({ addToast: mockAddToast });
