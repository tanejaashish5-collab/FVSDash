...
class ForgeVoiceAPITester:
    def __init__(self, base_url="https://video-monetize-flow.preview.emergentagent.com"):
...
def main():
    ...
    print("🌐 Testing against: https://video-monetize-flow.preview.emergentagent.com")
