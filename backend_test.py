...
class ForgeVoiceAPITester:
    def __init__(self, base_url="https://voice-studio-preview.preview.emergentagent.com"):
...
def main():
    ...
    print("🌐 Testing against: https://voice-studio-preview.preview.emergentagent.com")
