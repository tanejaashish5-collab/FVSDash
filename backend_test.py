...
class ForgeVoiceAPITester:
    def __init__(self, base_url="https://feedback-analytics-1.preview.emergentagent.com"):
...
def main():
    ...
    print("🌐 Testing against: https://feedback-analytics-1.preview.emergentagent.com")
