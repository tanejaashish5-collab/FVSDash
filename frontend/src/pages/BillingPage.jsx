          ...
          {process.env.REACT_APP_STRIPE_ENABLED === 'true' ? (
            ...
            <Card className="bg-[#0B1120] border-[#1F2933]">
              <CardContent className="py-16 text-center">
                ...
                <p className="text-zinc-400">You're on the ForgeVoice Studio beta plan — all features unlocked.</p>
                <p className="text-zinc-500 text-sm mt-2">Stripe billing integration coming soon.</p>
              </CardContent>
            </Card>
          )}
