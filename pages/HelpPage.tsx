...
import { OnboardingStep, ToastNotification } from '../types';
import { DEFAULT_FAQS, DEFAULT_ONBOARDING_STEPS } from '../constants';
...
const HelpPage: React.FC<HelpPageProps> = ({ onStartTour, addToast }) => {
